export const bridgeSubjects = {
  ...
  datasetSettingsUpdate: "eval.dataset.settings.update",
  datasetItemPromote: "eval.dataset.item.promote",
  datasetItemUpdate: "eval.dataset.item.update",
  ...
  scorerCreate: "eval.evaluation.create",
  scorerSearch: "eval.evaluation.search",
  evaluationCreate: "eval.evaluation.create",
  evaluationUpdate: "eval.evaluation.update",
  evaluationSearch: "eval.evaluation.search",
  evaluationRunStart: "eval.evaluation.run.start",
  evaluationRunCancel: "eval.evaluation.run.cancel",
  evaluationRunPause: "eval.evaluation.run.pause",
  evaluationRunResume: "eval.evaluation.run.resume",
  evaluationRunSearch: "eval.evaluation.run.search",
  ...
  optimizationSearch: "eval.optimization.search",
  optimizationGet: "eval.optimization.get",
  experimentCreate: "eval.evaluation.create",
  experimentStart: "eval.evaluation.run.start",
  experimentCancel: "eval.evaluation.run.cancel",
  experimentPause: "eval.evaluation.run.pause",
  experimentResume: "eval.evaluation.run.resume",
  optimizationStart: "eval.optimization.start",
  experimentSearch: "eval.evaluation.search",
  resultSearch: "eval.results.search",
  liveExperimentStart: "eval.live.start",
  liveExperimentStop: "eval.live.stop",
  annotationQueueSearch: "eval.dataset.candidates.search",
  annotationItemUpdate: "eval.dataset.item.update",
  promptVersionPromote: "eval.target.promote",
  ...
  aiQualityOverview: "eval.results.search",
} as const;
