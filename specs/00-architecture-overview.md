...
| `Subscription.liveExperimentRun` | API | AI-agent engineers | draft | `apps/backend` plus `core/storage-read` | `specs/03-contracts/graphql/public-schema.graphql` and `specs/03-flows/ai-eval/live-experiment-subscription.md` | remote_service | `website/src/content/handbook/guides/ai-eval.md` |
