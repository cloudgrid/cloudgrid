...
CloudGrid calls harness adapter endpoints for run, score, and optimize operations. The adapter responses never carry spans; harness emits telemetry to the OTLP collector.
