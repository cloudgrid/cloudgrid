---
title: "Invitations"
description: "Deployed SSO mode is invite-only after the first company admin has been bootstrapped."
order: 12
accent: amber
...
[Invitation email delivery](/handbook/configuration/deployed/invitation-email).
...
Configure a provider in [SSO overview](/handbook/configuration/deployed/sso), then configure
[invitation email delivery](/handbook/configuration/deployed/invitation-email).
