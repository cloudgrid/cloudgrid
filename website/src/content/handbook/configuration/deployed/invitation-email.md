---
title: "Invitation Email Delivery"
description: "Invitation email delivery is the deployed-mode onboarding path for people who are not already members of a CloudGrid company."
order: 13
accent: amber
...
[Invitation email delivery and project onboarding](/handbook/reference/contracts).
...
Review [Invitations](/handbook/configuration/deployed/invitations) for the acceptance lifecycle, then
continue with [SSO overview](/handbook/configuration/deployed/sso).
