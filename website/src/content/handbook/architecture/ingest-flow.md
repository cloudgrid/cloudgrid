---
title: "Ingest Flow"
description: "The ingest flow accepts OTLP data, publishes one persist command, and lets storage-write persist asynchronously."
order: 2
accent: brand
...
See the sender setup guide: [Ingest OTLP](/handbook/guides/ingest-otlp).
