---
title: "Product Tour"
description: "CloudGrid is organized around one selected project. A project is the boundary for telemetry, dashboards, live subscriptions, alert rules, retention."
order: 3
accent: brand
...
Run CloudGrid with [Local quickstart](/handbook/getting-started/local-quickstart), then send data with [Send telemetry](/handbook/getting-started/send-telemetry).
