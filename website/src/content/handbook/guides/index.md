...
| Goal | Guide |
| --- | --- |
| Send OpenTelemetry data | [Ingest OTLP](/handbook/guides/ingest-otlp) |
| Create or revoke ingest keys | [Project API keys](/handbook/guides/project-api-keys) |
| Investigate traces | [Trace investigation](/handbook/guides/trace-investigation) |
