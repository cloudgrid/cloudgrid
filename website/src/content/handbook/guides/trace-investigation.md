...
description: "Use /traces to find traces and /traces/:traceId to inspect one trace in depth."
order: 3
accent: violet
...
Use [Logs](/handbook/guides/logs) for trace-to-log pivots and [Live traces](/handbook/concepts/live-traces) for realtime behavior.
