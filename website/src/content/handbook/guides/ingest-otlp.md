---
title: "Ingest OTLP"
description: "CloudGrid receives telemetry through standard OpenTelemetry Protocol endpoints. Use your existing OpenTelemetry SDK or collector."
order: 1
accent: violet
...
After [Local quickstart](/handbook/getting-started/local-quickstart):
...
Create deployable project credentials with [Project API keys](/handbook/guides/project-api-keys).
