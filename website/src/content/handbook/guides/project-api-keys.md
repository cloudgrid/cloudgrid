...
description: "Project API keys are ingest credentials for services that send telemetry into one project."
order: 2
accent: violet
...
Configure services with [Ingest OTLP](/handbook/guides/ingest-otlp).
