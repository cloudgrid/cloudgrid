...
description: "Use the narrowest check that proves the docs, examples, or implementation you changed. For docs-only changes, git diff --check and a link check are."
order: 3
accent: emerald
