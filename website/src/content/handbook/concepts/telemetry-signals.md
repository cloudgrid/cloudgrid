...
description: "CloudGrid treats OpenTelemetry traces, logs, and metrics as first-class project-scoped signals."
order: 2
accent: cyan
...
Use [Send telemetry](/handbook/getting-started/send-telemetry) to send signals, then read the task guides for [traces](/handbook/guides/trace-investigation), [logs](/handbook/guides/logs), and [metrics](/handbook/guides/metrics).
