---
title: "Companies, Projects, And Access"
description: "CloudGrid has two durable ownership concepts: company and project."
order: 1
accent: cyan
...
Configure local access in [Local configuration](/handbook/configuration/local), or configure deployed SSO in [SSO overview](/handbook/configuration/deployed/sso).
