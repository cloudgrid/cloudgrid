...
description: "CloudGrid separates metric exploration from saved dashboard composition."
order: 4
accent: cyan
...
Use [Metrics guide](/handbook/guides/metrics) for exploration and [Dashboards guide](/handbook/guides/dashboards) for saved workspaces.
