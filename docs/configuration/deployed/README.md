...
- signed OCI images per service from the release workflow;
...
Configure [SSO providers](./sso/README.md), then review
[invitation email delivery](./invitation-email.md) and
[Kubernetes and deployment status](./kubernetes.md).
