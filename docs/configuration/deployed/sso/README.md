...
- [GitHub SSO](./github.md)
- [Google SSO](./google.md)
- [Azure Entra ID SSO](./azure.md)
...
Read [Invitations](../invitations.md) for the lifecycle and
[Invitation email delivery](../invitation-email.md) for the SMTP boundary.
