...
For a laptop setup, continue with [Local quickstart](../getting-started/local-quickstart.md). For shared mode configuration, start with [Deployed configuration](../configuration/deployed/README.md).
