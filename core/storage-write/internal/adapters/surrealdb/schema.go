...
func Statements() []string {
	...
	for _, table := range []string{
		...
		statements = append(statements,
			...
			"DEFINE FIELD OVERWRITE metricSettings ON "+table+" TYPE option<object> FLEXIBLE",
			"DEFINE FIELD OVERWRITE metricSettingsSnapshot ON "+table+" TYPE option<object> FLEXIBLE",
