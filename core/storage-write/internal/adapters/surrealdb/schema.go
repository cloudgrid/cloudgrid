...
func Statements() []string {
	...
	for _, table := range []string{
		...
		statements = append(statements,
			...
			"DEFINE FIELD IF NOT EXISTS id ON "+table+" TYPE string",
			...
			"DEFINE FIELD IF NOT EXISTS agent ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS costEstimate ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS definition ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS solverRef ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS summary ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS variableSchema ON "+table+" TYPE object FLEXIBLE",
			...
			"DEFINE FIELD IF NOT EXISTS evidence ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS tokenTotals ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS tokenDetails ON "+table+" TYPE object FLEXIBLE",
			"DEFINE FIELD IF NOT EXISTS tags ON "+table+" TYPE array<string>",
			"DEFINE FIELD IF NOT EXISTS scorerIds ON "+table+" TYPE array<string>",
			"DEFINE FIELD IF NOT EXISTS evalResultIds ON "+table+" TYPE array<string>",
			"DEFINE FIELD IF NOT EXISTS messageEventIds ON "+table+" TYPE array<string>",
			"DEFINE FIELD IF NOT EXISTS documentDigests ON "+table+" TYPE array<string>",
			"DEFINE FIELD IF NOT EXISTS itemRuns ON "+table+" TYPE array<any>",
			"DEFINE FIELD IF NOT EXISTS results ON "+table+" TYPE array<any>",
			"DEFINE FIELD IF NOT EXISTS normalizationWarnings ON "+table+" TYPE array<string>",
			...
			"DEFINE INDEX IF NOT EXISTS idx_"+table+"_tenant_project_id ON "+table+" FIELDS tenantId, projectId, id",
