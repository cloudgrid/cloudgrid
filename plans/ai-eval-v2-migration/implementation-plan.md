...
- Remaining work is integration tests and docs.
- `TICKET-202`, `TICKET-203`, `TICKET-204`, and `TICKET-205` are complete;
  wave 04 can start from durable storage, runner orchestration, and frontend
